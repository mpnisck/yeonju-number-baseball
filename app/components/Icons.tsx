...
export function IconBaseball({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <path
        d="M17.5 20.5C16 17.5 16 14 18 10c1-2 2.5-3.5 3.5-4.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
export function IconHash({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconCpu({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
